...
function card({ title, info, imgURL }) {
  return (
    <div className="bg-black w-[400px] mr-10 flex-shrink-0 rounded-[20px] p-3 cursor-grab">
      ...
      <div className="h-[160px] bg-[#18191D] rounded-[12px] p-3 pb-5 gap-3 my-4">
        {info.map(({ title, address }) => (
          <div className="flex rounded-[8px] bg-[#131417] items-center justify-between text-base py-2 pr-3 pl-[10px] mb-3">
            <h4>{title}</h4>
            <h4>{address}</h4>
          </div>
        ))}
